...
class CNNMoreLayer:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv4 = keras.layers.AveragePooling1D()(conv4)
...
class CNNMoreConv:
    ...
    def build_model(self, input_shape, nb_classes):
        ...
        conv1 = keras.layers.Conv1D(filters=64, kernel_size=8, padding='same', activation='relu')(input_layer)
        conv1 = keras.layers.Conv1D(filters=64, kernel_size=8, padding='same', activation='relu')(conv1)
        conv1 = keras.layers.AveragePooling1D()(conv1)
        ...
        conv3 = keras.layers.Conv1D(filters=256, kernel_size=5, padding='same', activation='relu')(conv2)
